...
![Рисунок 6 — Вывод маршрутов веб-приложения (flask routes).](figures/fig6_flask_routes.png)
...
Фактический результат представлен на рисунке 7.
![Рисунок 7 — Критический путь: оформление заказа через Telegram-бота.](figures/fig7_telegram_critical_path.png)
